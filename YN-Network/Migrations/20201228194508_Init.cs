        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceLogoUrl = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionA = table.Column<string>(type: "varchar(256)", nullable: true),
                    OptionB = table.Column<string>(type: "varchar(256)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<byte[]>(nullable: false),
                    UserId = table.Column<byte[]>(nullable: true),
                    OptionA = table.Column<bool>(type: "bool", nullable: false),
                    OptionB = table.Column<bool>(type: "bool", nullable: false),
                    Explanation = table.Column<string>(type: "varchar(256)", nullable: true),
